...
const BLOCK_HOST_SELECTOR =
    '.edit-block-wrapper, .arborito-quiz-edit, .arborito-callout-edit, .arborito-game-edit, .arborito-media-edit, .arborito-math-edit';
...
function insertHtmlLooksLikeBlock(html) {
    return /edit-block-wrapper|arborito-quiz-edit|arborito-game-edit|arborito-media-edit|arborito-callout-edit|arborito-math-edit|data-quiz-block/i.test(
        String(html || '')
    );
}
...
function insertHtmlIntoEditor(editorEl, html) {
    ...
    if (insertHtmlLooksLikeBlock(trimmed)) {
...
/** Inserts a Unicode math symbol at the caret inside the lesson editor. */
