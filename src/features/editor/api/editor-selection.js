...
export function isLessonEditorInsertControl(target) {
    ...
    return !!target.closest(
        '#btn-insert-quiz, #lesson-editor-insert-panel, .lesson-editor-insert-toggle, .lesson-editor-insert-panel__opt, .lesson-editor-toolbar-quiz'
    );
}

/** Dropdown toggles must receive a full click (not pointerdown preventDefault). */
...
/** @deprecated use isLessonEditorToolbarDropdownToggle */
export function isLessonEditorFormatDropdownToggle(target) {
    return isLessonEditorToolbarDropdownToggle(target);
}
