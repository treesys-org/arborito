...
export function useLessonConstructDnD({
    ...
    useEffect(() => {
        ...
        const onToolbarPress = (ev) => {
            ...
            if (isLessonEditorFormatToolbarControl(ev.target)) {
                ev.preventDefault();
            }
        };
        ...
        if (!quizObserverRef.current) {
            ...
            const bindAddedBlocks = (nodes) => {
                for (const node of nodes) {
                    ...
                    const blocks = node.matches('.arborito-quiz-edit, .arborito-game-edit, .arborito-media-edit')
                        ? [node]
                        : [
                              ...node.querySelectorAll(
                                  '.arborito-quiz-edit, .arborito-game-edit, .arborito-media-edit'
                              ),
                          ];
