...
function CurriculumLangSelect({
    ...
    langKeys,
    curriculumEditLang,
    curriculumLangPickerEpoch = 0,
    appLang,
    constructionMode,
    canOfferCurriculumLanguageAdd,
    canOfferCurriculumLanguageRemove,
    addCurriculumLanguageInteractive,
    removeCurriculumLanguage,
    ...
    return (
        <CurriculumLangPicker
            key={`con-lang-picker-${selectValue}-${curriculumLangPickerEpoch}`}
            langKeys={langKeys}
            value={selectValue}
            ariaLabel={fieldLb}
            compact
...
export function ConstructionToolbar({
    ...
    const retL = ui.revokePublicTreeDockTooltip || 'Unpublish this public copy';
    const retShort = ui.revokePublicTreeDockLabel || 'Unpublish';
                            ...
                            <div className="px-4 pt-4 w-full box-border" role="group" aria-label={secCurriculum}>
                                ...
                                <div className="construction-more__field">
                                    ...
                                    <CurriculumLangSelect
                                        ...
                                        canOfferCurriculumLanguageRemove={canOfferCurriculumLanguageRemove}
                                        addCurriculumLanguageInteractive={addCurriculumLanguageInteractive}
                                        removeCurriculumLanguage={removeCurriculumLanguage}
