...
function isTocHeadingLine(trimmed) {
    ...
    /* @quiz fences and the legacy @quizv2 marker are body content, not TOC entries. */
...
/** Meta @quiz block (declared in the file header) belongs in the first TOC section only. */
