...
export function SageDynamicConsent({ ui, sageEnterAnim, isAi, onSwitchMode, onAccept, onDecline, embedded = false }) {
    ...
    const optionalLine =
        ...
        'AI is optional, lessons, quizzes, and games work without it.';
    ...
    const body = (
        <div className={DOCK_SHEET_SCROLL_PAD}>
            <Callout tone="blue" layout="stack" extraClass="mb-4">
                <div className="arborito-callout__body m-0 text-sm leading-relaxed">
                    <LocaleRichText html={optionalLine} />
                    {gdprBody ? (
                        <p className="mt-2 mb-0 text-xs font-semibold text-slate-500 dark:text-slate-400">
                            {gdprBody}
                        </p>
                    ) : null}
                </div>
        ...
        <div id="sage-chat-overlay" className="sage-chat-overlay" aria-live="polite" aria-busy="true">
            <div className="sage-chat-overlay__card">
                <Callout
                    ...
                    title={overlay.title}
                    body={overlay.msg}
                    extraClass="sage-chat-overlay__callout w-full border-0 bg-transparent shadow-none p-0 mb-2"
        ...
        <div id="sage-chat-overlay" className="sage-chat-overlay" aria-live="polite">
            <div className="sage-chat-overlay__card">
                <Callout
                    ...
                    title={consent.title}
                    body={consent.body}
                    extraClass="sage-chat-overlay__callout w-full border-0 bg-transparent shadow-none p-0 mb-3"
                    titleClass="sage-chat-overlay__title arborito-callout__title m-0"
