...
export function useSageState() {
    ...
    const switchSageAiMode = useCallback(
        (nextMode) => {
            ...
            if (nextMode === 'guide') {
                ...
                /* desktop: single download/privacy prompt grants both consents */
    ...
    const acceptDynamicConsent = useCallback(() => {
        ...
        /* Desktop model download has its own consent screen — do not skip it. */
    ...
    const cancelSageLoading = useCallback(() => {
        ...
        revokeSageDownloadConsent();
        sageModelInitStartedRef.current = false;
        sageModelInitDeclinedRef.current = true;
        setSageAiMode('guide');
        setSageAiModeState('guide');
        setGuideNav(defaultSageGuideNav());
        store.update({
    ...
    const screen = useMemo(() => {
        ...
        if (sageAiMode === 'dynamic') {
            ...
            /* Desktop: one privacy/download prompt (grants experimental + download). */
