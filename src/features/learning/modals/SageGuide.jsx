...
export function SageGuide({
    ...
    const { setModal, selectedNode, requestGoHome, toggleConstructionMode } = learning;
    ...
    const runGuideAction = useCallback(
        ...
        [ctxOpts, nav, onClose, popGuideNav, setGuideNav, ui, learning, requestGoHome, toggleConstructionMode, setModal]
    );
    ...
    return (
        <SageDeskGuideShell enterAnim={sageEnterAnim} onDismiss={onClose}>
            {panel}
        </SageDeskGuideShell>
    );
}
