...
/** Third-party media consent overlay (lessons, tree info, etc.). */
export function MediaConsentModal({ pending, onAccept, onDecline }) {
    ...
    return (
        <ModalCenteredShell
            ...
            footer={
                <div className="arborito-modal-footer arborito-modal-footer--bg-flat flex flex-col-reverse sm:flex-row gap-2 sm:justify-end">
                    <button
                        type="button"
                        id="btn-media-consent-decline"
                        className="px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-200 font-semibold text-sm hover:bg-slate-50 dark:hover:bg-slate-800"
                        onClick={onDecline}
                    >
                    ...
                    <button
                        ...
                        className="arborito-cta-sky px-4 py-2.5 rounded-xl font-bold text-sm shadow"
                        onClick={onAccept}
                    >
