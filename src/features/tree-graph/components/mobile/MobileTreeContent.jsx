...
function MobileMovePickBanner() {
    ...
    return (
        <div className="arborito-move-pick-banner pointer-events-auto w-full max-w-xl rounded-xl border border-amber-500/45 bg-amber-50 dark:bg-amber-950/88 text-amber-950 dark:text-amber-50 px-3 py-2 shadow-lg flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
            ...
            <button
                type="button"
                className="arborito-move-pick-cancel shrink-0 text-xs font-black uppercase tracking-wide px-3 py-1.5 rounded-lg bg-amber-200/90 dark:bg-amber-900/75 text-amber-950 dark:text-amber-100 border border-amber-700/15"
                onClick={cancelMove}
            >
                {ui.cancel || 'Cancel'}
            </button>
