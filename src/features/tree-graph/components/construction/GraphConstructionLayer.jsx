...
function ComposedAddBranchPopover({ state }) {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => document.addEventListener('click', onDoc, true), 0);
        return () => {
            clearTimeout(timer);
            document.removeEventListener('click', onDoc, true);
        };
    ...
    return createPortal(
        <div className="arborito-composed-add-popover arborito-float-modal-card arborito-float-modal-card--compact" style={style} role="dialog" aria-label={ui.graphFabAddComposedBranch || 'Add branch'}>
        ...
        >
            ...
            >
                ...
                <div className="flex gap-2 justify-end">
                    <button
                        type="button"
                        className="arborito-cta-slate px-4 py-2.5 rounded-xl font-bold text-sm"
