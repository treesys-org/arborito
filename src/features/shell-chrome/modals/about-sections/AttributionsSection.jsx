const ATTRIBUTION_ITEMS = [
    ...
    },
    {
        key: 'html2pdf.js',
        lic: 'MIT',
        href: 'https://github.com/eKoopmans/html2pdf.js',
        licHref: 'https://opensource.org/licenses/MIT',
        noteKey: 'aboutAttributionsHtml2pdf',
        defaultNote: 'In-browser PDF export © Erik Koopmans, bundled offline.',
    },
    {
        key: 'jsPDF',
        lic: 'MIT',
        ...
        licHref: 'https://opensource.org/licenses/MIT',
        noteKey: 'aboutAttributionsJspdf',
        defaultNote: 'PDF generation © James Hall, bundled offline.',
    },
    {
        key: 'Tailwind CSS',
        lic: 'MIT',
