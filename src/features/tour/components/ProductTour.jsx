...
export function ProductTour({ embed }) {
    ...
    /* Lesson-edit tour highlights chrome; blocking shades made the body untouchable
     * (toolbar worked, caret never appeared). Pass clicks through so authors can type. */
    const shadePassThrough = mode === 'lesson-edit';
