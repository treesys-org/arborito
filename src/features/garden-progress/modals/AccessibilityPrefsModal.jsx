...
export function ModalAccessibilityPrefs({ embed = false }) {
    ...
    const prefsIntro = isDesktop
        ? ui.a11yPrefsIntro || ''
        : pickHostUi(ui, 'a11yPrefsIntro', 'a11yPrefsIntroApp', ui.a11yPrefsIntro || '');
    const platformNote = isDesktop
        ? ui.a11yDesktopPlatformNote || ''
        : pickHostUi(
              ui,
              'a11yWebPlatformNote',
              'a11yAppPlatformNote',
              ui.a11yWebPlatformNote || ''
          );
    const optionsHeading = isDesktop
        ? ui.a11yPrefsTitle || 'Accesibilidad'
        : pickHostUi(
              ui,
              'a11yWebOptionsHeading',
              'a11yAppOptionsHeading',
              'Opciones en el navegador'
          );
    const voiceFooterNote = isDesktop
        ? ui.a11ySageVoiceNote || ''
        : pickHostUi(ui, 'a11yWebVoiceNote', 'a11yAppVoiceNote', ui.a11yWebVoiceNote || '');
