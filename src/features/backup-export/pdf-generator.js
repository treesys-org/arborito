...
import { parseArboritoFile, markdownToVisualHTML } from "../editor/editor-engine.js";
...
/** Human-readable tree/author/source labels for PDF (never raw local:// URLs). */
...
class PdfGenerator {
    ...
    async generate(nodes, onProgress) {
        ...
        const footerText = sanitizeLocaleRichHtml(
            String(ui.pdfFooter || '').replaceAll('{name}', meta.footerName)
        );
    ...
    _getStyles() {
        return `
            ...
            /* --- Typography --- */
            h1, h2, h3, h4 { font-family: system-ui, sans-serif; color: #111; font-weight: 800; }
            ...
            .meta { font-size: 9pt; color: #777; text-transform: uppercase; font-family: system-ui, sans-serif; letter-spacing: 1px; margin-top: -20px; }
            ...
            .logo { font-family: system-ui, sans-serif; font-weight: 900; font-size: 20pt; color: #444; margin-bottom: 40px; }
            .cover-title { font-size: 36pt; border: none; margin: 20px 0; line-height: 1.2; }
            .cover-subtitle { font-size: 14pt; color: #666; font-style: italic; margin-bottom: 12px; }
            .cover-tree-meta {
                font-size: 11pt;
                color: #333;
                margin: 0 0 28px;
            ...
            .cover-footer { margin-top: 20px; font-family: system-ui, sans-serif; color: #888; font-size: 10pt; }
            ...
            @media print {
                ...
                .arborito-quizv2-edit { display: none !important; }
            }
        `;
    }
}
