        ...
        <DockModalShell
            ...
            hero={
                <ModalHero
                    ...
                    title={title}
                    titleTruncate
                    leadingIcon={<span className="text-3xl shrink-0">⚠️</span>}
            ...
            footer={
                <div className="arborito-modal-footer arborito-modal-footer--bg-flat">
                    <button
                        type="button"
                        className="btn-confirm arborito-cta-rose w-full py-3 min-h-[44px] rounded-xl font-bold shadow-lg shadow-red-500/20 transition-transform active:scale-95"
                        onClick={onConfirm}
                    >
                        {confirmLabel}
                    </button>
