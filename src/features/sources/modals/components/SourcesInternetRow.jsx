...
export function SourcesInternetRow({
    ...
    const activeMatches =
        !!activeRef &&
        String(activeRef.pub) === ownerPub &&
        String(activeRef.universeId) === universeId;
    const titleEmoji = resolveOnlineListingIcon({
            ...
            {open ? (
                <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    {showOwnerAppeal ? (
                        <button
                            type="button"
                            className="arborito-sources-action-chip arborito-sources-action-chip--warn"
