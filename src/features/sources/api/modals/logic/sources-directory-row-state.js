...
export const SOURCES_REPORT_HIDE_THRESHOLD_BASE = 8;
/** Cap so obscure trees still hide at a finite ceiling. */
export const SOURCES_REPORT_HIDE_THRESHOLD_MAX = 28;

/** @deprecated use computeReportHideThreshold */
export const SOURCES_REPORT_HIDE_THRESHOLD = SOURCES_REPORT_HIDE_THRESHOLD_BASE;
