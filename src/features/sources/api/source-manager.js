...
import { DEFAULT_NOSTR_RELAYS, normalizeNostrRelayUrls } from '../../nostr/api/nostr-relays-runtime.js';
...
export class SourceManager {
    ...
    async discoverManifest(sourceUrl) {
        if (!sourceUrl || sourceUrl.startsWith('branch://') || parseNostrTreeUrl(sourceUrl)) {
