...
export function useSourcesModal(embed = false) {
    ...
    const mainTabs = useMemo(
        () => [
            { id: 'branches', label: ui.sourcesTabBranches || 'Branches' },
            { id: 'trees', label: ui.sourcesTabTrees || 'Trees' },
        ],
        [ui.sourcesTabBranches, ui.sourcesTabTrees]
    );
    ...
    const tabSubtitle = useMemo(() => {
        ...
        return (
            ...
            'Full courses — plant, import, install from the network and study.'
        );
