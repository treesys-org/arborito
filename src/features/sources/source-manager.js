...
import { parseNostrTreeUrl, formatNostrTreeUrl, isNostrNetworkAvailable } from '../nostr/nostr-refs.js';
import { isNostrTreeMaintainerBlocked } from '../nostr/maintainer-nostr-tree-blocklist.js';
import { DEFAULT_BOOT_SOURCE } from './official-tree.js';
import { resolveTreeInput } from './tree-aliases.js';
import { getManifestDiscoveryRoots, expandLibraryHttpsAlternates } from './library-mirrors.js';
import { DEFAULT_NOSTR_RELAYS, normalizeNostrRelayUrls } from '../nostr/nostr-relays-runtime.js';
...
export class SourceManager {
    ...
    /**
     * Phase 4: re-render hook so private-synced local trees in the sources
     * modal pick up changes (the trees themselves live in
     * `userStore.state.localTrees` with a `privateSyncedFromAccount` flag).
     */
