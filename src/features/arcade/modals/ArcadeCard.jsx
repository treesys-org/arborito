    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-3 shrink-0 self-end sm:self-auto">
                ...
                <button
                    type="button"
                    className={`px-4 py-2 ${wateringTargetId ? 'arborito-cta-blue' : 'arborito-btn-neutral hover:scale-105'} text-xs font-bold rounded-xl shadow-lg transition-all active:scale-95`}
