...
export const GAME_SDK_CORE_FRAGMENT = iframeSdkBlock([
    ...
    '        var busyLabelDefault = (user.lang === \'ES\') ? \'Cargando respuesta…\' : \'Loading response…\';',
    '        if (typeof bridge.setAiBusy === \'function\') {',
    '            try { bridge.setAiBusy(true, options.busyLabel || busyLabelDefault); } catch (_) {}',
    '        }',
    '        try {',
    ...
    '                    bridge.aiChat([{role: \'user\', content: augmented}], options.lesson || null),',
    '                    timeoutPromise',
    '                ]);',
    ...
    '        } finally {',
    '            if (typeof bridge.setAiBusy === \'function\') {',
    '                try { bridge.setAiBusy(false); } catch (_) {}',
    '            }',
    '        }',
    '    }',
    '',
