...
export const GAME_SDK_API_FRAGMENT = iframeSdkBlock([
    ...
    '            },',
    '            /** Grounded lesson simulation (terminal, tutor, NPC, …). opts.role customizes tone. */',
    '            lessonAction: async function(lesson, input, opts) {',
    '                if (aiMode === \'static\') {',
    '                    throw makeError(CODES.SAGE, \'AI not available in static mode. Switch to Dynamic AI mode to use ask.lessonAction.\');',
    '                }',
    '                opts = opts || {};',
    '                if (!opts.persona && playSessionConfig.persona) opts.persona = playSessionConfig.persona;',
    '                return askJSONImpl(lessonActionPrompt(lesson, input, opts), null, opts.askOptions);',
    '            }',
    '        },',
    '        ai: {',
    '            get persona() { return playSessionConfig.persona; },',
    '            set persona(v) { playSessionConfig.persona = String(v || \'\'); },',
    '            get arborito() { return playSessionConfig.persona; },',
    '            set arborito(v) { playSessionConfig.persona = String(v || \'\'); }',
    '        },',
    '        play: {',
    '            configure: playConfigure,',
    '            boot: playBoot,',
    '            startLesson: playStartLesson,',
    '            submit: playSubmit,',
    '            nextLesson: playNextLesson,',
    '            currentTask: playCurrentTask,',
