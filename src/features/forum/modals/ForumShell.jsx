...
function ForumPanelShell({ panelHost, embedded, mobile, onClose, hero, footer, children, onBackdropClick }) {
    if (embedded) {
        return (
            <div
                data-embed="1"
                className="arborito-forum-embed-root flex flex-col flex-1 min-h-0 w-full min-w-0 overflow-y-auto custom-scrollbar"
            >
                {children}
                {footer}
            </div>
