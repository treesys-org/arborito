...
/** Destructive confirm — readable label, no uppercase shrink. */
export const MODAL_CTA_CONFIRM_DANGER =
    'btn-confirm py-3 min-h-[48px] font-black rounded-xl shadow-lg transition-transform active:scale-95 text-sm normal-case tracking-normal arborito-cta-red';

export function modalCtaConfirmDanger() {
    return MODAL_CTA_CONFIRM_DANGER;
}

export function modalCtaConfirmDangerFull() {
    return `${MODAL_CTA_CONFIRM_DANGER} w-full`;
}
