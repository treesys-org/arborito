...
export const MOBILE_DOCK_SHEET_ROOT_FLAG_RE =
    /\barborito-modal--(?:arcade|forum|certificates-hub|search|tree-info|node-properties|construction-dock-hub|profile|dialog|backup|about|language|download-app|preview|celebration-prefs|accessibility-prefs)\b|\barborito-search-dock\b/u;
