import { shouldShowMobileUI, useDesktopForestShell } from './breakpoints.js';
import {
...
export function syncMobileTreeShellClass(store, opts = {}) {
    ...
    const deskForestOnly = useDesktopForestShell();
    ...
    /* Dock pill stays visible for hub modals + dock-tab sage/search/arcade (not lesson sage, not More). */
