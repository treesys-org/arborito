...
/** @deprecated Vite hashes CSS chunks. */
export function versionedStylesheetHref(path) {
    return path;
}
...
export function prefetchSourcesModalChunk() {
    ...
    void ensureModalChunk('security-warning');
    void ensureModalChunk('load-warning');
}
...
/** About embed in mobile More — prefetch before first drill. */
export function prefetchAboutModalChunk() {
    void ensureModalChunk('about');
}
