/**
 * Trusted locale strings (locales/<lang>/*.json) sometimes include a small HTML subset.
...
/** True when a locale string likely contains trusted markup (not escaped entities). */
export function looksLikeLocaleRichHtml(raw) {
