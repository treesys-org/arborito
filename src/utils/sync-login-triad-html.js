/**
 * Sync secret presentation: code-first, and file as secondary action.
 */

/**
 * @param {Record<string, string>} ui
 * @param {{ plainSecret: string, username: string }} reveal
 * @param {(s: string) => string} escHtml
 * @param {(s: string) => string} escAttr
 * @param {{ profileMasking?: boolean, codeRevealed?: boolean }} [opts]
 */
