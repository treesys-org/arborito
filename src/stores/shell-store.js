...
export class ShellStore extends EventTarget {
    constructor() {
        ...
        /** Blocks re-entrant closeDialog (Enter + click, double tap). */
        this._dialogSettling = false;
        ...
        this.state = {
            ...
            /** Optional subtitle while treeGrowingOverlay is on (i18n string). */
            ...
            /** Remount curriculum lang pickers after cancel of unsaved-leave confirm. */
    ...
    notify(msg, isError = false, durationMs) {
        const ms =
    ...
    confirm(body, title, danger = false, confirmText) {
        return confirmLifecycle(this, body, title, danger, confirmText);
    }
