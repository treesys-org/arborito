...
/** @deprecated Store boot binds singleton via store-singleton; kept as no-op. */
export function bindShellUiActions(_store) {
    /* shellUiActions resolve via getArboritoStore() */
}
