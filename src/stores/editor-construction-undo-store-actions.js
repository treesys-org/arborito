...
/** @type {Promise<typeof import('../shell-lazy-init.js')>|null} */
let _shellLazyInitPromise = null;

function warmConstructionShell() {
    if (!_shellLazyInitPromise) {
        _shellLazyInitPromise = import('../shell-lazy-init.js');
    }
    void _shellLazyInitPromise.then((m) => m.prefetchConstructionOnIntent());
}
