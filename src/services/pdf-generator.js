...
import { escAttr as escHtml } from "../utils/html-escape.js";
...
export class PdfGenerator {
    ...
    async generate(nodes, onProgress) {
        ...
        const disclaimerText = sanitizeLocaleRichHtml(
            ui.pdfDisclaimerText.replace('{url}', escHtml(String(repoUrl != null ? repoUrl : '')))
        );
        const footerText = sanitizeLocaleRichHtml(
            ui.pdfFooter.replace('{name}', escHtml(String(repoName != null ? repoName : '')))
        );
        ...
        <div class="cover-page">
            <div class="cover-content">
                ...
                <div class="cover-footer">
                    <p>Generated on ${escHtml(dateStr)}</p>
                    <p class="small">${escHtml(repoName)}</p>
                </div>
            </div>
        </div>
