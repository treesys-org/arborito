...
import { afterConstructionModeMutation } from '../features/editor/construction-sync.js';
...
export class UIStore extends EventTarget {
    constructor() {
        ...
        this.state = {
            ...
            treeHydrating: false,
            /** Fullscreen "El árbol está creciendo…" overlay; opt-in flag set by
             ...
             *  the "Publicando árbol…" toast and the construction-panel edit
    ...
    _closeSageHost() {
        ...
        const el = document.querySelector('arborito-sage');
