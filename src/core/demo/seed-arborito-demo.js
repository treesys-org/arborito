...
import { importBundledDemoMedia } from './import-demo-media.js';
...
export function maybeSeedArboritoDemo(userStore) {
    ...
    userStore.persist?.();
    writeSeedVersion();
    void importBundledDemoMedia(DEMO_BRANCH_ID).catch((e) => {
        console.warn('[Arborito] demo media seed failed', e);
    });
    return true;
}
