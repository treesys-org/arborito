...
import { formatNostrTreeUrl } from '../services/nostr-refs.js';
...
import { countCareDue } from '../utils/care-reminders.js';

export function renderSidebarHtml(ctx) {

        const { theme, lang, viewMode, modal, selectedNode, previewNode, gamification, constructionMode, activeSource, availableReleases } = store.value;
    ...
    return {
            ...
            <div class="arborito-desktop-actions" aria-label="Actions">
                ...
                <div class="arborito-desktop-profile-wrap arborito-desktop-hit" aria-haspopup="menu">
                    ...
                    <div class="arborito-desktop-profile-popover" role="menu" aria-label="${ui.navMore || 'Menu'}">
                        ...
                        <button type="button" class="arborito-desktop-menu-item js-btn-desktop-forum" role="menuitem">${icDesktopMenu.forum}<span class="arborito-desktop-menu-item__txt">${ui.navForum || 'Forum'}</span></button>
                        ...
                        <div class="rounded-2xl border border-sky-200/80 dark:border-sky-800/70 bg-white/80 dark:bg-slate-900/70 backdrop-blur px-4 py-3 shadow-sm">
                            <div class="flex items-start justify-between gap-3">
                                ...
                                <div class="flex flex-col gap-2 shrink-0">
                                    <button type="button" class="js-cloudsync-enable px-3 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-black uppercase tracking-wider">${
        ...
        ${isDesktop ? `
        ` : `
        <div class="arborito-mob-top-actions" role="toolbar" aria-label="${escSidebarHtml(`${ui.navProfile || 'Profile'} · ${ui.themeToggle || 'Theme'}`)}">
