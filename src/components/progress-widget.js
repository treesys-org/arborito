...
class ArboritoProgressWidget extends HTMLElement {
    ...
    /**
     * Cuerpo compacto: progreso, semillas y trofeos (móvil); en escritorio puede omitir bloque jardín y acciones.
        ...
        return `
            ...
            <div class="arborito-mochila-course">
                <div class="arborito-mochila-course__head">
                    <span class="arborito-mochila-course__title">${ui.progressTitle || 'Progress'}</span>
    ...
    render() {
        ...
        const compactCtx = {
            ui, g, stats, dailyProgress, dailyGoalVal, collectedItems, certsAll, seedsWord, trophyLabel, seedsLabel, dueCount
        };
        ...
        <div class="relative">
            ...
            <div class="arborito-desktop-mochila-host">
                <aside class="arborito-mochila-card" aria-label="${escAttr(ui.progressTitle || 'Garden')} — ${escAttr(seedsWord)} & ${escAttr(trophyLabel)}">
                    <div class="arborito-mochila-card__head">
                        ...
                        <div class="arborito-mochila-card__titles">
                            <h2 class="arborito-mochila-card__title">${ui.progressTitle || 'Garden'}</h2>
                ...
                <div id="mobile-widget-overlay" class="fixed inset-0 z-[120] bg-slate-950 flex flex-col items-stretch justify-start p-0 pb-[max(0.75rem,var(--arborito-mob-dock-clearance,4.25rem))] animate-in fade-in">
                    <div class="arborito-modal-dock-panel w-full flex flex-col flex-1 min-h-0 max-h-full overflow-hidden cursor-auto">
                        <div class="arborito-sheet__hero arborito-sheet__hero--mmenu-sub arborito-dock-modal-hero shrink-0 flex items-center gap-2">
                            <button type="button" id="btn-close-mobile" class="arborito-mmenu-back shrink-0" aria-label="${ui.navBack || 'Back'}">←</button>
                            <h2 class="arborito-mmenu-subtitle m-0 flex-1 min-w-0">🎒 ${ui.progressTitle || 'Garden'}</h2>
