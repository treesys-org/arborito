            ...
            if (this._arcadeSetupHeaderKey !== setupHeaderKey) {
                ...
                <div class="arborito-sheet__hero arborito-sheet__hero--mmenu-sub arborito-dock-modal-hero shrink-0 flex items-center gap-2">
                    ...
                    <div class="min-w-0 flex-1 text-left">
                        <h2 class="arborito-mmenu-subtitle m-0">${this.selectedGame.name}</h2>
                        <p class="text-xs text-slate-600 dark:text-slate-400 mt-1 font-medium">${ui.arcadeSetup || "Game Setup"}</p>
                    </div>
                </div>`
                    : `
                <div class="arborito-float-modal-head arborito-dock-modal-hero shrink-0 px-4 pt-4 pb-2 gap-3 items-center">
                    <div class="min-w-0 flex-1 text-left">
                        <h2 class="arborito-mmenu-subtitle m-0 leading-tight">${this.selectedGame.name}</h2>
                        <p class="text-xs text-slate-500 dark:text-slate-400 font-semibold uppercase tracking-wider mt-1">${ui.arcadeSetup || "Game Setup"}</p>
                    </div>
