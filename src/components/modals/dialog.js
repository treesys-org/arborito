...
class ArboritoModalDialog extends HTMLElement {
    ...
    render() {
        ...
        this.innerHTML = `
        <div id="modal-backdrop" class="fixed inset-0 z-[200] flex items-start justify-center pt-[min(18vh,5.5rem)] pb-10 px-4 overflow-y-auto bg-slate-950 animate-in fade-in duration-200 arborito-modal-root">
