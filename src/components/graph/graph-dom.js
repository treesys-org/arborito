export function initDOM() {
        ...
        <style>
            ...
            .mobile-knot-tone-root.mobile-knot--svg {
                width: 3rem; height: 3rem; min-width: 3rem; min-height: 3rem;
                border-radius: 50% !important;
                background: rgba(141, 110, 99, 0.28) !important;
                border: none !important;
                box-shadow: 0 0 0 4px rgba(34, 197, 94, 0.12), 0 0 16px rgba(34, 197, 94, 0.28) !important;
                transform: none;
            }
            .mobile-knot-tone-root.mobile-knot--svg.active {
                background: rgba(22, 80, 22, 0.38) !important;
                transform: scale(1.08);
                box-shadow: 0 0 0 6px rgba(34, 197, 94, 0.18), 0 0 24px rgba(34, 197, 94, 0.45), 0 0 40px rgba(34, 197, 94, 0.2) !important;
            }
