...
export class UIStore extends EventTarget {
    constructor() {
        ...
        this.state = {
            ...
            /** Leaf id to open in repaso mode (jump to quiz); cleared after lesson opens. */
            pendingRepasoLessonId: null,
            /** After .arborito import: summary for one-shot UI. */
            importRepasoSummary: null
        };
    }
