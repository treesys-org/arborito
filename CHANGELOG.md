...
- Catalog and chrome copy: the nav and panel are **Courses** / **Cursos**; combined courses are **playlists**. Tours, Sage shortcuts, Logros, and the bundled Arborito demo use the same words (no Fuentes / Catálogo / Bosque mix in the UI).
