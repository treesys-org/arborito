#!/usr/bin/env node
/**
 * Fail when hand-written CSS still carries mobile-selector or theme duplication.
 *
...
if (violations.length) {
    console.error(`[check-css-conventions] ${violations.length} issue(s):\n`);
...
console.log(`[check-css-conventions] OK : ${scanned} CSS file(s) scanned`);
