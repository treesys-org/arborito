...
function ensureChromiumTempDir() {
  const candidates = [
    process.env.ARBORITO_CHROMIUM_TMP,
    process.env.XDG_CACHE_HOME && path.join(process.env.XDG_CACHE_HOME, 'arborito', 'chromium-tmp'),
    path.join(os.homedir(), '.cache', 'arborito', 'chromium-tmp'),
