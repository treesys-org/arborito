...
| Close Forest modal after load? | [`src/features/sources/api/sources-session.js`](../src/features/sources/api/sources-session.js), `finishSourcesLoadSession()` closes only when `modal.fromOnboarding` |
...
| Network loads from Forest | `runBibliotecaNetworkLoad()` in `connected-services/runtime.js` (wraps `runConnectedNetworkLoad`) |
...
| Forest filter chips | [`src/features/sources/modals/components/SourcesFilterChip.jsx`](../src/features/sources/modals/components/SourcesFilterChip.jsx) |
...
| Forest network loads | [`runBibliotecaNetworkLoad()`](../src/shared/lib/connected-services/runtime.js) |
