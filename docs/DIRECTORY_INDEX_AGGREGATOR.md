...
2. **`src/features/p2p-webtorrent/api/directory-index-config.js`** — Set `DIRECTORY_INDEX_TRUSTED_PUBLISHERS` to the aggregator’s **`pub`** string (exact match). Rebuild the app you ship.
