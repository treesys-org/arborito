...
4. **Second visit:** open the same HTTP lesson again — it must be served from **IndexedDB** ([`lesson-content-cache.js`](../src/features/learning/lesson-content-cache.js)) after the first load.
