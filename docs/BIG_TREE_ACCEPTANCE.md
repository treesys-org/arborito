...
Template for manual validation **before tagging a new version**, once you have a reference course or fixture (decide on N nodes / M MB). The alpha at [arborito.org](https://arborito.org) is still young, the goal is to catch regressions before they reach users.
