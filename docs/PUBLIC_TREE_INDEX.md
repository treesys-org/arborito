...
Short curated names can also ship in [`src/features/sources/api/tree-aliases.js`](../src/features/sources/api/tree-aliases.js) for deployments you control; keep the same minimization rules—only public metadata the author agreed to list.
